...
class $CategoryTable extends category_table.Category
  ...
  late final GeneratedColumn<material.Color> color =
      GeneratedColumn<material.Color>(
        'color',
        aliasedName,
        false,
        type: const ColorColumn(),
        requiredDuringInsert: true,
      );
  static const VerificationMeta _iconMeta = const VerificationMeta('icon');
  @override
  late final GeneratedColumn<HogastosIcon> icon = GeneratedColumn<HogastosIcon>(
    'icon',
    aliasedName,
    false,
    type: const HogastosIconColumn(),
    requiredDuringInsert: true,
  );
  ...
  VerificationContext validateIntegrity(
    Insertable<Categories> instance, {
...
class Categories extends DataClass implements Insertable<Categories> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['icon'] = Variable<HogastosIcon>(icon, const HogastosIconColumn());
  ...
  factory Categories.fromJson(
    ...
    return Categories(
      ...
      icon: serializer.fromJson<HogastosIcon>(json['icon']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'icon': serializer.toJson<HogastosIcon>(icon),
...
class CategoryCompanion extends UpdateCompanion<Categories> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (icon.present) {
      map['icon'] = Variable<HogastosIcon>(
        icon.value,
        const HogastosIconColumn(),
      );
    }
...
class MovementCompanion extends UpdateCompanion<Movements> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] = Variable<MovementType>(
        type.value,
        const MovementTypeColumn(),
      );
    }
...
abstract class _$Db extends GeneratedDatabase {
  ...
  late final Index categoryDescription = Index(
    'category_description',
    'CREATE INDEX category_description ON category (description)',
  );
  late final Index movementId = Index(
    'movement_id',
    'CREATE INDEX movement_id ON movement (id)',
  );
  late final Index movementDate = Index(
    'movement_date',
    'CREATE INDEX movement_date ON movement (date)',
  );
  late final Index movementType = Index(
    'movement_type',
    'CREATE INDEX movement_type ON movement (type)',
  );
  late final Index movementDateType = Index(
    'movement_date_type',
...
final class $$CategoryTableReferences
  ...
  _movementRefsTable(_$Db db) => MultiTypedResultKey.fromTable(
    db.movement,
    aliasName: $_aliasNameGenerator(db.category.id, db.movement.categoryId),
  );

  $$MovementTableProcessedTableManager get movementRefs {
    final manager = $$MovementTableTableManager(
      $_db,
      $_db.movement,
...
class $$CategoryTableFilterComposer extends Composer<_$Db, $CategoryTable> {
  ...
  ColumnFilters<HogastosIcon> get icon => $composableBuilder(
    column: $table.icon,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CategoryTableOrderingComposer extends Composer<_$Db, $CategoryTable> {
  ...
  ColumnOrderings<HogastosIcon> get icon => $composableBuilder(
    column: $table.icon,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CategoryTableAnnotationComposer extends Composer<_$Db, $CategoryTable> {
  ...
  GeneratedColumn<HogastosIcon> get icon =>
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<HogastosIcon> icon = const Value.absent(),
                Value<DateTime?> deletedAt = const Value.absent(),
              }) => CategoryCompanion(
                id: id,
...
typedef $$CategoryTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool movementRefs})
    >;
typedef $$MovementTableCreateCompanionBuilder =
    MovementCompanion Function({
      Value<int> id,
      required DateTime date,
      required String description,
      required int categoryId,
...
typedef $$MovementTableUpdateCompanionBuilder =
    MovementCompanion Function({
      Value<int> id,
      Value<DateTime> date,
      Value<String> description,
...
class $$MovementTableTableManager
    extends
        RootTableManager<
          _$Db,
          $MovementTable,
              ...
              (p0) =>
                  p0
                      .map(
                        (e) => (
                          e.readTable(table),
                          $$MovementTableReferences(db, table, e),
                        ),
                      )
                      .toList(),
                ...
                if (categoryId) {
                  state =
                      state.withJoin(
                            ...
                            referencedTable: $$MovementTableReferences
                                ._categoryIdTable(db),
                            referencedColumn:
                                $$MovementTableReferences
                                    ._categoryIdTable(db)
                                    .id,
                          )
                          as T;
...
typedef $$MovementTableProcessedTableManager =
    ProcessedTableManager<
      _$Db,
      $MovementTable,
      Movements,
